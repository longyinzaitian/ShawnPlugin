...
import com.shawn.plugin.lib.manager.PluginManagerProvider;
...
public class ProcessUtil {
    ...
    public static boolean isPluginProcess(Context context) {
        if (isPluginProcess == null) {
            ...
            if (TextUtils.isEmpty(processName) || TextUtils.isEmpty(pluginProcessName)) {
                LogUtil.e(TAG, "a fatal error happened, should throw an exception here?",
                        "processName:" + processName + ", pluginProcessName:" + pluginProcessName);
            }
    ...
    public static boolean isPluginProcess() {
        return isPluginProcess(PluginConfig.getHostContext());
    }
    ...
    private static String getPluginProcessName(Context context) {
        try {
            ...
            LogUtil.e(TAG, "ProcessUtil.getPluginProcessName", e.getLocalizedMessage());
        }
        return "";
    }
}
